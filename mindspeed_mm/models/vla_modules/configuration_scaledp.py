...
class ScaleDPPolicyConfig(PretrainedConfig):
    ...
    def __init__(
        ...
        self.adaptive_pool_dim = adaptive_pool_dim
        self.cond_dim = cond_dim
        self.state_dim = state_dim
        self.state_embed_dim = state_embed_dim if state_dim > 0 else 0
